$(document).ready(function() { 
    ...
    function KiemtraMa () {
        ...
        if(!re.test(txtMa.val())){ 
            tbMa.html("* Mã tour theo mẫu: XXX-XXX-99-0099"); 
            return false; 
        } 
        tbMa.html("*"); 
        return true; 
    ...
    // kiểm tra ngày khởi ha2h, phải sau ngày hiện tại 
    var txtNgay = $("#txtNgay");
    var tbNgay = $("#tbNgay");
    ...
    $("#btnSave").click(function(){ 
        ...
        var ho=  $("#txtho").val();
        var ten= $("#txtten").val();
        var them= "<tr><td>"+ (i++) +"</td><td>" + matour +"</td><td>" + diemden +"</td><td>" + ngaykh +"</td><td>" + tg +"</td><td>" + gia +"</td><td>" + anh +"</td></tr>" + ho +"</td></tr>" + ten +"</td></tr>"; 
