...
title='TỈ LỆ ĐÓNG GHÓP CỦA DOANH SỐ THEO TỪNG DANH MỤC TRONG TỪNG NĂM')
...
app.layout = html.Div(
    children=[
        ...
        html.Div(
            children=[
                html.H1(
                    children="TỔNG DOANH SỐ", className="header-name"
                ),
                html.Div(
         ...
         html.Div(
            children=[
                html.H1(
                    children="DOANH SỐ CAO NHẤT", className="header-name"
                ),
                html.Div(
         ...
         html.Div(
            ...
            children=[
                html.H1(
                    children="TỔNG LỢI NHUẬN", className="header-name"
                ),
                html.Div(
         ...
         html.Div(
            ...
            children=[
                html.H1(
                    children="LỢI NHUẬN CAO NHẤT", className="header-name"
                ),
                html.Div(
